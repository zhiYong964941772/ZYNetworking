...
pod repo push HYMusicPrivatePods ZYNetworking.podspec --verbose --allow-warnings --use-libraries --use-modular-headers --sources='https://github.com/CocoaPods/Specs.git'
